...
Blockchain is as unique and different to understand to newcomers as the internet was to people in 1999. It is difficult to understand even for early adopters. We seek to make it easier for VR users who tend to be early adopters of new technology.

* Star Wars Podracing meets TribeXR
* Blockchain NFTs and Electronic Dance Music. A CyberPunk Virtual Reality Racing game to Teach Blockchain

Users learn about polkadot and blockchain as they design their coinracer. 
They then get to use what they learned and compete against the other racers.
...
The game is to educate users on the Polkadot blockchain through the use of Virtual & Augmented Reality. 

Each user builds their own customized CoinRacer. The engine is a visual representation of how blockchain is powered and instead of with words, we use physically stacking existing pieces together, much like blockchain innovation works today. The design of the vehicle is the sleek sexy part the users get to design. This is where the user gets introduced to non-fungible art and create an NFT.

The user also gets to design their own custom avatar suit using preset options, linking to an NFT marketplace on Polkadot. 

The environment is generated by AI so every time the user enters a race, the race is a never before seen course, creating a unique playing experience every time.
...
Users play - learn - and get rewarded. The more they play the more they learn the more rewards they get. 
...
We could do this by creating in game sponsors by blockchain companies just like F1 racing by putting Blockchain Protocol brand logos on the CoinRacers to promote blockchain interopability with Polkadot's parachain ability. 

We are pioneering blockchain education through gaming. 
...
We see it a significant challenge with current tron style racing game on Oculus Quest where users experience mootion sickness due to fast speed and poor game mechanics. The racing part of the game would need to be a much smaller portion of the game if we have similar issues. Our focus would be 80% on the actual design of the racer and seeing how other users create their racer. It could be connected to an existing NFT marketplace where users publish their work. 
...
Promote on Oculus Quest: Quill Theatre. Can recieve 1600-2000 experience loads per month for a Quillistration (VR Illustration) video. 
